...
<div class="main-content position-relative max-height-vh-100 h-100">
    ...
    <!-- End Navbar -->
    <div class="card shasdow-lg mx-4 card-profile-bottom">
        <div class="card-body p-3">
            <div class="row gx-4">
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1">Cluster
                            <?php echo $arr_cls[0]->user_cluster_id ?>
                        </h5>
                        ...
                        <div class="container">
                            <div class="user-list">
                                <div class="row align-items-center">
                                    <?php for ($i = 0; $i < count($arr_cls); $i++) { ?>
                                    <div class="col-md-4 col-xs-6">
                                        <div class="user-detail">
                                            <img src="https://se.buu.ac.th/gami_ossd/assets/dist/img/user/unknown-who.jpg"
                                                alt="User Image"
                                                onerror="this.onerror=null;this.src='https://se.buu.ac.th/gami_ossd/assets/dist/img/user/unknown-who.jpg';"
                                                style="object-fit: cover; object-position: center;margin: 7px 0px;width: 200px;height: 200px;"><br>
                                            <span class="users"
                                                style="margin-top: 15px;font-size: 22px;"><?php echo $arr_cls[$i]->user_name . " " . $arr_cls[$i]->user_lastname ?></span><br>
                                            <span class="users" href="#นายอัศวิน อนันตศร"
                                                style="font-size: 17px;"><?php echo $arr_cls[$i]->user_username ?></span><br>
                                            <b><span class="users"
                                                    style="font-size: 17px;"><?php echo $arr_cls[$i]->role_name ?></span></b>
                                        </div>
